...
const en = {
  ...
  "history.undo": "Undo last MusicSpec change",
  "history.redo": "Redo MusicSpec change",
  "history.undoTitle": "Undo · Ctrl / ⌘ + Z",
  "history.redoTitle": "Redo · Ctrl / ⌘ + Shift + Z",
  "app.copied": "Copied",
  ...
  "preview.manualAria": "Edit final Style prompt manually",
  "preview.manualHint": "Final output override. Studio edits no longer update this Style; use Advanced custom wording for ongoing structured work.",
  "preview.manualGuardTitle": "Final output edit",
  "preview.manualGuardBody": "Manual editing freezes the current Style as an output override. Further Studio/MusicSpec changes keep updating the deterministic original underneath, but they will not update this final Style until you restore the original.",
  "preview.manualGuardAdvanced": "Still building the sound? Keep this locked and put the wording in Advanced → Custom wording inside the matching facet. That stays in MusicSpec and keeps Live Prompt/source navigation connected.",
  "preview.manualGuardConfirm": "Edit final Style",
  "preview.manualGuardCancel": "Keep building in Studio",
  ...
  "preview.manualActive": "Final manual override active · Studio edits no longer update this Style. Restore original to reconnect it.",
  ...
  "poolView.aria": "Pool quick view",
  "poolView.all": "All",
  "poolView.favorites": "Favorites",
  "poolView.recent": "Recent",
...
const de: Catalog = {
  ...
  "history.undo": "Letzte MusicSpec-Änderung rückgängig machen",
  "history.redo": "MusicSpec-Änderung wiederholen",
  "history.undoTitle": "Rückgängig · Ctrl / ⌘ + Z",
  "history.redoTitle": "Wiederholen · Ctrl / ⌘ + Shift + Z",
  "app.copied": "Kopiert",
  "copyFallback.eyebrow": "Clipboard-Fallback",
  ...
  "preview.manualAria": "Finalen Style Prompt manuell bearbeiten",
  "preview.manualHint": "Finaler Output-Override. Studio-Änderungen aktualisieren diesen Style nicht mehr; nutze für weitere strukturierte Arbeit Advanced mit eigener Formulierung.",
  "preview.manualGuardTitle": "Finale Ausgabe bearbeiten",
  "preview.manualGuardBody": "Manuelles Bearbeiten friert den aktuellen Style als Output-Override ein. Weitere Änderungen im Studio/MusicSpec aktualisieren weiterhin das deterministische Original im Hintergrund, aber nicht diesen finalen Style, bis du das Original wiederherstellst.",
  "preview.manualGuardAdvanced": "Baust du noch am Sound? Lass den Prompt gesperrt und nutze im passenden Facet Advanced → Eigene Formulierung. So bleibt die Änderung in MusicSpec und Live Prompt samt Quellen-Navigation verbunden.",
  "preview.manualGuardConfirm": "Finalen Style bearbeiten",
  "preview.manualGuardCancel": "Im Studio weiterarbeiten",
  ...
  "preview.manualActive": "Finaler manueller Override aktiv · Studio-Änderungen aktualisieren diesen Style nicht mehr. Stelle das Original wieder her, um ihn erneut zu verbinden.",
  ...
  "poolView.aria": "Pool-Schnellansicht",
  "poolView.all": "Alle",
  "poolView.favorites": "Favoriten",
  "poolView.recent": "Zuletzt",
